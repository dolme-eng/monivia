...
const localStats = [
  { icon: TrendingUp, value: '3.200+', label: 'pratiche elaborate' },
  { icon: Users, value: '1.200+', label: 'clienti a Firenze' },
...
export default function PrestitiAFirenzeClient() {
  return (
    <main className="min-h-screen overflow-hidden bg-white pb-24 md:pb-0">
      ...
      <section className="relative overflow-hidden bg-primary pb-20 pt-32 sm:pt-36 text-white">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1543429776-2782f8f3e2b4?w=1200" alt="" fill priority className="object-cover opacity-15" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-primary/40 via-primary/75 to-primary" />
        <div className="site-container relative z-10">
          <Breadcrumbs className="mb-10 [&_a]:text-white/60 [&_a:hover]:text-secondary [&_span]:text-white/80" items={[{ label: 'Home', href: '/' }, { label: 'Prestiti a Firenze' }]} />
          <div className="text-center">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.25 }} className="text-hero-lead mt-5 mx-auto max-w-2xl text-white/75">
              Finanziamento nella città dell&apos;arte
            </motion.p>
      ...
      <section className="section-pad bg-slate-50">
        <div className="site-container">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerChildren}>
            ...
            <h2 className="section-heading mb-10">I nostri servizi a Firenze</h2>
          </motion.div>
      ...
      <section className="section-pad">
        <div className="site-container max-w-3xl">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerChildren}>
            ...
            <h2 className="section-heading mb-10">Cosa dicono i nostri clienti a Firenze</h2>
          </motion.div>
          <motion.div variants={staggerChildren} initial="initial" whileInView="animate" viewport={{ once: true }}>
            <motion.div variants={fadeInUpAnimate} className="rounded-xl border border-slate-100 bg-white p-6 sm:p-8">
              ...
              <p className="text-slate-600 leading-relaxed">&ldquo;A Firenze ho trovato le migliori condizioni per il mio prestito personale. Consigliatissimo.&rdquo;</p>
              <div className="mt-4 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-sm font-bold text-white">EM</div>
                <div>
                  <div className="text-sm font-bold text-primary">Elena M.</div>
                  <div className="text-xs text-slate-400">31 anni</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="section-pad bg-primary text-white text-center">
        <div className="site-container max-w-2xl">
          <h2 className="text-section-title font-black">Pronto a richiedere il tuo prestito a Firenze?</h2>
