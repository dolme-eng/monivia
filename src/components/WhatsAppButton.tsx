...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-[7.5rem] right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-105 sm:bottom-7 sm:right-7"
    >
