           ...
           >
             <motion.div variants={fadeInUp} className="mb-12">
               ...
               <p className="text-lg text-slate-600 max-w-2xl mx-auto font-medium">
                 Offriamo soluzioni di finanziamento da <span className="text-primary font-black">5.000€ a più di 500.000€</span>, 
             ...
             <div className="grid md:grid-cols-3 gap-6">
               {[
                 ...
                 <motion.div 
                   key={i}
                   variants={fadeInUp}
                   className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-xl hover:border-secondary/20 transition-all group text-center md:text-left"
                 >
                   <div className="w-14 h-14 rounded-2xl bg-secondary/10 text-secondary flex items-center justify-center mx-auto md:mx-0 mb-6 group-hover:bg-secondary group-hover:text-white transition-colors">
                     {item.icon}
                   </div>
