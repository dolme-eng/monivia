      ...
      <section className="section-pad border-t border-slate-100 bg-slate-50">
        <div className="site-container">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <Link href="/prestiti-a-roma" className="group rounded-xl border border-slate-200 bg-white p-5 transition-all hover:-translate-y-0.5 hover:border-secondary/30 hover:shadow-md">
              <h3 className="text-sm font-bold text-slate-900 group-hover:text-secondary">Prestiti a Roma</h3>
              <p className="mt-2 text-xs text-slate-400">Richiedi un prestito a Roma con tasso fisso e risposta in 48 ore.</p>
            </Link>
