...
import { CheckCircle, ArrowRight, Clock, Shield, FileCheck, Banknote, Briefcase, Lock, Zap, Users } from 'lucide-react';
...
const features = [
  { icon: Banknote, title: 'Tasso fisso', desc: 'La tua rata resta invariata per tutta la durata del prestito.' },
  { icon: Lock, title: 'Rate fisse', desc: 'Nessuna variazione: pianifica il tuo budget con certezza.' },
  { icon: Shield, title: 'Nessuna garanzia extra', desc: 'Niente ipoteche né garanti aggiuntivi.' },
  { icon: Zap, title: 'Approvazione rapida', desc: 'Esito in 48 ore lavorative dalla richiesta.' },
];

const benefits = [
  { icon: Briefcase, title: 'Dipendenti pubblici e privati', desc: 'Accessibile a tutti i dipendenti a tempo indeterminato.' },
  { icon: Users, title: 'Perfetto per famiglie', desc: 'Importi adeguati alle esigenze della tua famiglia.' },
  { icon: Shield, title: 'Sicurezza e trasparenza', desc: 'Costi chiari e nessuna sorpresa.' },
];

const steps = [
  { num: '01', title: 'Compila il modulo', desc: 'Inserisci dati anagrafici e reddito in pochi minuti.' },
  { num: '02', title: 'Carica i documenti', desc: 'Busta paga e codice fiscale, direttamente online.' },
...
const faqItems = [
  { q: 'Chi può richiedere un prestito per dipendenti?', a: 'Possono richiederlo tutti i dipendenti a tempo indeterminato, pubblici e privati, con almeno 6 mesi di anzianità aziendale.' },
  { q: 'Serve una busta paga per richiedere il prestito?', a: 'Sì, serve l\'ultima busta paga e un estratto conto degli ultimi 3 mesi per dimostrare la stabilità del reddito.' },
  { q: 'Qual è l\'importo massimo ottenibile?', a: 'L\'importo massimo dipende dal tuo reddito e dalla durata del prestito. In generale è possibile ottenere fino a 7 volte lo stipendio mensile netto.' },
  { q: 'Qual è la durata massima del prestito?', a: 'La durata massima è di 120 mesi (10 anni). La rata mensile è fissa e non cambia per tutta la durata del prestito.' },
  { q: 'Serve un garante per il prestito dipendenti?', a: 'No, il prestito per dipendenti non richiede garanti né ipoteche. La garanzia principale è la trattenuta in busta paga oppure la valutazione del merito creditizio.' },
];

export default function PrestitoDipendentiClient() {
  return (
    <main className="min-h-screen overflow-hidden bg-white pb-24 md:pb-0">
      ...
      <section className="relative overflow-hidden bg-primary pb-20 pt-32 sm:pt-36 text-white">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1200" alt="" fill priority className="object-cover opacity-15" />
        </div>
        <div className="absolute inset-0 bg-gradient-to-b from-primary/40 via-primary/75 to-primary" />
        <div className="site-container relative z-10">
          <Breadcrumbs className="mb-10 [&_a]:text-white/60 [&_a:hover]:text-secondary [&_span]:text-white/80" items={[{ label: 'Home', href: '/' }, { label: 'Prestito Dipendenti' }]} />
          <div className="text-center">
            ...
            <motion.div variants={staggerChildren} initial="initial" animate="animate" className="mt-8 flex flex-wrap justify-center gap-2 sm:gap-3">
              {['Tasso fisso', 'Rate fisse', 'Nessuna garanzia extra', 'Approvazione rapida'].map((f) => (
      ...
      <section className="section-pad">
        <div className="site-container">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerChildren}>
            ...
            <h2 className="section-heading mb-10">Il prestito per dipendenti</h2>
          </motion.div>
      ...
      <section className="section-pad bg-slate-50">
        <div className="site-container">
          <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={staggerChildren}>
            ...
            <h2 className="section-heading mb-10">I vantaggi del prestito dipendenti</h2>
          </motion.div>
      ...
      <section className="section-pad bg-primary text-white text-center">
        <div className="site-container max-w-2xl">
          <h2 className="text-section-title font-black">Sei dipendente? Richiedi il tuo prestito ora</h2>
          <p className="mt-4 text-white/75">Tasso fisso, rate fisse, nessuna sorpresa. Compila il modulo in pochi minuti.</p>
